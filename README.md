...
<h1 align="center">🏥 Posyandu ILP API</h1>
...
-   **🔐 Otentikasi Keamanan**: Menggunakan Laravel Sanctum untuk sistem login secure berbasis token.
-   **👥 Manajemen Peserta**: Kelola data penduduk dari berbagai kategori (Balita, Ibu Hamil, Remaja, Dewasa/Lansia).
-   **📋 Pencatatan Kunjungan**: Dokumentasi hasil pemeriksaan kesehatan rutin (berat badan, tinggi badan, tekanan darah, dll).
-   **📊 Dashboard Stats**: Endpoint khusus untuk menyajikan data ringkasan dan grafik tren kesehatan.
-   **🛡️ Role-Based Access**: Mendukung peran Admin dan Kader untuk pembatasan akses data.
...
<p align="center">
  Dibuat dengan ❤️ untuk kemajuan kesehatan masyarakat.
</p>
